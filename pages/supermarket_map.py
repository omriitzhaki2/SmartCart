...
# image = Image.open("layout/map.jpg")  # Replace "path_to_your_image.jpg" with the actual path to your image
...
if not st.session_state.finish:
    ...
    with col1:
        ...
        shortest_path = find_shortest_products_path_greedy(G)
        plot_shortest_path_on_map(shortest_path)
        st.image("layout/map.jpg")
    with col2:
        st.markdown("### Grocery List:")
        for idx, (item, location) in enumerate(shortest_path, start=0):
